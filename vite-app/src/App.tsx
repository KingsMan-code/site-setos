...
function App() {
  return (
    <>
      <nav className="flex flex-row items-center gap-8 text-[var(--textDim)] w-full box-border z-[9999]">
        <p className="sitename font-bold">CoolSite</p>
        <p className="nav-menu">Services</p>
        <p className="nav-menu">Pricing</p>
        <p className="nav-menu">Features</p>
        <p className="nav-menu">About us</p>
        <svg className="material-icons" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 9H5c-.55 0-1 .45-1 1s.45 1 1 1h14c.55 0 1-.45 1-1s-.45-1-1-1zM5 15h14c.55 0 1-.45 1-1s-.45-1-1-1H5c-.55 0-1 .45-1 1s.45 1 1 1z"/></svg>
      </nav>
      ...
      <a href="https://dribbble.com/shots/23181733-Blurry-Glassmorphic-Modern-Landing-page" target="_blank" className="button button-first">
        <button>View Source</button><span></span>
      </a>

      <a href="https://youtu.be/1pW_sk-2y40" target="_blank" className="button button-sec">
        <button>Watch Video</button><span></span>
      </a>

      <a href="https://x.com/juxtopposed" target="_blank" className="button button-third">
